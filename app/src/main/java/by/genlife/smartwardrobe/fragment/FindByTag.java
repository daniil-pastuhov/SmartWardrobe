 ...
 */
public class FindByTag extends Fragment {
    public static final String TAG = FindByTag.class.getSimpleName();

    private static FindByTag instance;
    private Context context;
    private EditText searchStr;
    private ListViewAdapter results;
    private View noResult;

    public static FindByTag getInstance() {
        if (instance == null) {
            instance = new FindByTag();
        }
        return instance;
    }

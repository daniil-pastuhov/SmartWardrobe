...
package by.genlife.fancycoverflow;
...
public class FancyCoverFlow extends Gallery {
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        if (!(adapter instanceof CoverFlowAdapter)) {
            throw new ClassCastException(FancyCoverFlow.class.getSimpleName() + " only works in conjunction with a " + CoverFlowAdapter.class.getSimpleName());
        }
